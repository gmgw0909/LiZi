...
public class RecordedButton extends View {
    ...
    private void init() {
        ...
        dp5 = (int) getResources().getDimension(R.dimen.margin_bigger_micro);
        colorBg = getResources().getColor(R.color.video_bt_bg);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF r1 = new RectF();
        r1.left = measuredWidth / 3 - 5;
        r1.right = measuredWidth / 3 + 100;
        r1.top = measuredWidth / 3 - 5;
        r1.bottom = measuredWidth / 3 + 100;
        canvas.drawRoundRect(r1, 7, 7, paint);
        //绘制进度
