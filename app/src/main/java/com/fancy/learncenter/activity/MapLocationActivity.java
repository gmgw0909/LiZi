...
import com.fancy.learncenter.adapter.SearchResultAdapter;
...
public class MapLocationActivity extends BaseActivity implements LocationSource,
    ...
    private float zoomSize = 13f;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_map_location, Status.Default);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.back:
                ...
                break;
            case R.id.next:
                selectedItem = resultData.get(searchResultAdapter.getSelectedPosition());
                Intent i = new Intent();
                i.putExtra(Constant.LOCATION_STRING, selectedItem.getTitle());
...
//        Log.i("MY", "onLocationChanged");
        if (mListener != null && amapLocation != null) {
            if (amapLocation != null
                ...
                aMap.moveCamera(CameraUpdateFactory.newLatLngZoom(curLatlng, zoomSize));
                isInputKeySearch = false;
                searchText.setText("");
            } else {
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(MapLocationActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void searchPoi(Tip result) {
        ...
        aMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(searchLatlonPoint.getLatitude(), searchLatlonPoint.getLongitude()), zoomSize));
