...
public class FirendNearbyAdapter extends CommonRecycleViewAdapter<String> {

    public FirendNearbyAdapter(Context mContext, ArrayList<String> itemDatas) {
        super(mContext, R.layout.firend_nearby_item, itemDatas);
    }
